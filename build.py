...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/find_object/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/find_object/archive/master.zip", tmp)
    file += "master"
