...
_LVISFREQUENCY = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="FREQUENT", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="COMMON", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RARE", index=3, number=3, serialized_options=None, type=None
        ),
    ],
...
_STRINGINTLABELMAPITEM_KEYPOINTMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="protos.StringIntLabelMapItem.KeypointMap.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="protos.StringIntLabelMapItem.KeypointMap.label",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="protos.StringIntLabelMapItem.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="protos.StringIntLabelMapItem.id",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="display_name",
            full_name="protos.StringIntLabelMapItem.display_name",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="keypoints",
            full_name="protos.StringIntLabelMapItem.keypoints",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ancestor_ids",
            full_name="protos.StringIntLabelMapItem.ancestor_ids",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="descendant_ids",
            full_name="protos.StringIntLabelMapItem.descendant_ids",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="frequency",
            full_name="protos.StringIntLabelMapItem.frequency",
            index=6,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="instance_count",
            full_name="protos.StringIntLabelMapItem.instance_count",
            index=7,
            number=8,
            type=5,
            cpp_type=1,
...
_STRINGINTLABELMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="item",
            full_name="protos.StringIntLabelMap.item",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
